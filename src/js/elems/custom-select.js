class CustomSelect {
  ...
  static CLASS_NAME_SELECT_SELECTED = 'select_selected';
  ...
  _reset() {
    ...
    this._elToggle.textContent = '<span class="select__clear"></span>';
  ...
  _changeValue(option) {
    this._elRoot.classList.add(CustomSelect.CLASS_NAME_SELECT_SELECTED);
...
document.querySelectorAll('.select').forEach((e) => new CustomSelect(e));